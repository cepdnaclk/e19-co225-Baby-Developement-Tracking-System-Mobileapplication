...
public class BabyAdapterMidWife extends RecyclerView.Adapter<BabyAdapterMidWife.ViewHolder> {

    private List<Guardian> guardians;
    private Context context;

    public BabyAdapterMidWife(List<Guardian> guardians, Context context) {
        this.guardians = guardians;
        this.context = context;
    }
    ...
    public void updateData(List<Guardian> newData) {
        guardians.clear();
        guardians.addAll(newData);
